...
def piggy_points(score):
    ...
    """
    # BEGIN PROBLEM 2
    squared_score = score * score
    mi = 10
    while squared_score >= 10:
        t = squared_score % 10
        if t < mi:
            mi = t
        squared_score //= 10
...
def more_boar(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    player_score = change_to_double_digit(player_score)
    opponent_score = change_to_double_digit(opponent_score)
    ...
    if opponent_score < 10:
        return False
    first_of_player_score = player_score//10
    second_of_player_score = player_score%10
    first_of_opponent_score = opponent_score//10
    second_of_opponent = opponent_score%10
    return first_of_player_score < first_of_opponent_score and second_of_player_score < second_of_opponent
    # END PROBLEM 4

def change_to_double_digit(x):
    while x >= 100:
        x //= 10
    return x
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    score0, score1 = play(strategy0, strategy1, score0, score1, dice, goal, say)
    return score0,score1
